...
<head>
    ...
    <link rel="stylesheet" href="../css_main/styleofertas.css">
...
<body>
    ...
    <main>
        ...
        <h2 class="containerofert_title">Te presentamos algunas de nuestras ofertas</h2>
            ...
            <div class="cards_ofert">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        <img src="../assets/img-Uimw-uGT-large.jpg" alt="">
                        <p class="ofert_title">Aspirina</p>
                        <p class="original_p">Precio Original: <b>S/ 12.50</b></p>
                        <p class="ofert_p">Precio Oferta: <b>S/ 10.00</b></p>
                ...
                <div class="cardofert">
                    ...
                    <span></span>
                    <div class="glass_card">
                        <img src="../assets/paisaje-2-e1549600987975.jpg" alt="">
                        <p class="ofert_title">Aspirina</p>
                        <p class="original_p">Precio Original: <b>S/ 12.50</b></p>
                        <p class="ofert_p">Precio Oferta: <b>S/ 10.00</b></p>
                        <a class="cart_button" href="../login-register/login.php">
