...
<body>
    ...
    <main>
        ...
        <h2 class="containerofert_title">Productos disponibles | Categoría: Medicinas</h2>
            ...
            <div class="cards_ofert">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Agente antimicrobiano, útil para limpiar las heridas.</p>
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Alcohol etílico de pH neutro y agradablemente perfumado</p>
                        <div class="pre_button">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Para el alivio de dolores de cabeza y músculos</p>
                        <div class="pre_button">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Neutralizante de la secreción ácida gástrica</p>
                        <div class="pre_button">
            ...
            <div class="cards_ofert cards_ofertsec">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Antipirético, analgésico y antiinflamatorio.</p>
                        <div class="pre_button">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Analgésicos utilizado principalmente para tratar la fiebre y malestares</p>
                        <div class="pre_button">
