...
<body>
    ...
    <main>
        ...
        <h2 class="containerofert_title">Productos disponibles | Categoría: Nutrición</h2>
            ...
            <div class="cards_ofert">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Medicamento de vitamina C de venta bajo receta médica</p>
                        <div class="pre_button">
                ...
                <div class="cardofert lastcard">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="ofert_title">Hidrolágeno Q10</p>
                        <p class="description_cat">Suplemento alimenticio cuya formulación contiene antioxidantes</p>
                        <div class="pre_button">
            ...
            <div class="cards_ofert cards_ofertsec">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Capsulas multivitamínicas, minerales y ginseng</p>
                        <div class="pre_button">
                ...
                <div class="cardofert">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Fórmula balanceada para suplir las necesidades nutricionales</p>
                        <div class="pre_button">
                ...
                <div class="cardofert lastcard">
                    ...
                    <div class="glass_card">
                        ...
                        <p class="description_cat">Ayuda a los pacientes a manejar sus niveles de azúcar</p>
                        <div class="pre_button">
